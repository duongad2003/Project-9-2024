...
{
    public partial class ac_user : Form
    {
        public ac_user()
        {
            InitializeComponent();
        ...
        private void btn_Them_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlInsert = "INSERT INTO [nguoidung] (tk, mk) VALUES (@tentk, @mk)";
        ...
        private void btn_Sua_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlUpdate = "UPDATE [nguoidung] SET mk = @mk WHERE tk = @tentk";
        ...
        private void btn_Xóa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string sqlDelete = "DELETE FROM [nguoidung] WHERE tk = @tentk";
