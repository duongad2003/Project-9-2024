...
namespace Login.In
{
    public partial class InSinhVien : Form
    {
        ...
        private void LoadReport()
        {
            ...
            ReportDataSource rds = new ReportDataSource("dtSinhVien", dt);
            reportViewer1.LocalReport.DataSources.Clear();
            reportViewer1.LocalReport.DataSources.Add(new ReportDataSource("dtSinhVien", dt));
